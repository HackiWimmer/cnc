...
#define VERSION_H
	...
	#define CNC_VERSION_INDEX_VAL    4
	// -----------------------------------------------------------------------------------------------------------------
	...
	const unsigned int CNC_BUILD_YEAR_INT       = BUILD_YEAR;
	const unsigned int CNC_BUILD_MONTH_INT      = BUILD_MONTH;
	const unsigned int CNC_BUILD_DAY_INT        = BUILD_DAY;
	const unsigned int CNC_BUILD_HOUR_INT       = BUILD_HOUR;
	...
	const unsigned int CNC_VERSION_BUILD_NUM    = CNC_BUILD_YEAR_INT
	                                            ...
	                                            + CNC_BUILD_HOUR_INT   * 24
	                                            + CNC_BUILD_MIN_INT    * 60
