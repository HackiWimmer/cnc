...
CncToolMagazineBase::CncToolMagazineBase(wxWindow* parent,
    wxWindowID id,
    const wxPoint& pos,
    const wxSize& size,
    long style)
    : wxPanel(parent, id, pos, size, style)
{
    ...
    m_toolMagazine = new wxListCtrl(this, wxID_ANY, wxDefaultPosition, wxDLG_UNIT(this, wxSize(-1, 120)),
        wxLC_VRULES | wxLC_HRULES | wxLC_SINGLE_SEL | wxLC_REPORT | wxALWAYS_SHOW_SB | wxVSCROLL);
    ...
    m_staticText5046 =
        new wxStaticText(this, wxID_ANY, _("Common Settings:"), wxDefaultPosition, wxDLG_UNIT(this, wxSize(-1, -1)), 0);
    ...
    m_staticText5056 = new wxStaticText(
        this, wxID_ANY, _("Consider Default Tool:"), wxDefaultPosition, wxDLG_UNIT(this, wxSize(-1, -1)), 0);

    flexGridSizer5085->Add(m_staticText5056, 0, wxALL, WXC_FROM_DIP(5));

    m_cbDefaultToolUsage =
        new wxCheckBox(this, wxID_ANY, _(" - on demand"), wxDefaultPosition, wxDLG_UNIT(this, wxSize(-1, -1)), 0);
    ...
    m_staticText5058 = new wxStaticText(
        this, wxID_ANY, _("Default Tool mapped to:"), wxDefaultPosition, wxDLG_UNIT(this, wxSize(-1, -1)), 0);

    flexGridSizer5084->Add(m_staticText5058, 0, wxALL | wxALIGN_RIGHT, WXC_FROM_DIP(5));

    wxArrayString m_cbDefaultMappedToArr;
    m_cbDefaultMappedTo = new wxComboBox(this, wxID_ANY, wxT(""), wxDefaultPosition, wxDLG_UNIT(this, wxSize(60, 24)),
        m_cbDefaultMappedToArr, wxCB_SORT | wxCB_READONLY);
    ...
    m_staticText5050 =
        new wxStaticText(this, wxID_ANY, _("Tool Parameter:"), wxDefaultPosition, wxDLG_UNIT(this, wxSize(-1, -1)), 0);
    ...
    m_staticText4609 =
        new wxStaticText(this, wxID_ANY, _("ID:"), wxDefaultPosition, wxDLG_UNIT(this, wxSize(-1, -1)), 0);

    flexGridSizer5052->Add(m_staticText4609, 0, wxALL, WXC_FROM_DIP(5));

    m_toolMagazineId =
        new wxTextCtrl(this, wxID_ANY, wxT(""), wxDefaultPosition, wxDLG_UNIT(this, wxSize(30, -1)), wxTE_RIGHT);
    ...
    m_toolMagazineTypeArr.Add(_("PEN"));
    m_toolMagazineTypeArr.Add(_("BIT"));
    m_toolMagazineType = new wxComboBox(this, wxID_ANY, wxT(""), wxDefaultPosition, wxDLG_UNIT(this, wxSize(-1, -1)),
        m_toolMagazineTypeArr, wxCB_READONLY);
    ...
    m_staticText4617 =
        new wxStaticText(this, wxID_ANY, _("Diameter:"), wxDefaultPosition, wxDLG_UNIT(this, wxSize(-1, -1)), 0);

    flexGridSizer5052->Add(m_staticText4617, 0, wxALL, WXC_FROM_DIP(5));

    m_toolMagazineDiameter =
    ...
    m_staticText5064 =
        new wxStaticText(this, wxID_ANY, _("Length:"), wxDefaultPosition, wxDLG_UNIT(this, wxSize(-1, -1)), 0);

    flexGridSizer5052->Add(m_staticText5064, 0, wxALL, WXC_FROM_DIP(5));

    m_toolMagazineLength =
        new wxTextCtrl(this, wxID_ANY, wxT("0.000"), wxDefaultPosition, wxDLG_UNIT(this, wxSize(-1, -1)), wxTE_RIGHT);
#if wxVERSION_NUMBER >= 3000
    ...
    m_staticText5068 =
        new wxStaticText(this, wxID_ANY, _("Offset:"), wxDefaultPosition, wxDLG_UNIT(this, wxSize(-1, -1)), 0);

    flexGridSizer5052->Add(m_staticText5068, 0, wxALL, WXC_FROM_DIP(5));

    m_toolMagazineOffset =
        new wxTextCtrl(this, wxID_ANY, wxT("0.000"), wxDefaultPosition, wxDLG_UNIT(this, wxSize(-1, -1)), wxTE_RIGHT);
#if wxVERSION_NUMBER >= 3000
    ...
    m_btToolMagazineRemove =
        new wxButton(this, wxID_ANY, _("Remove"), wxDefaultPosition, wxDLG_UNIT(this, wxSize(90, 24)), 0);
    ...
    m_btToolMagazineDuplicate =
        new wxButton(this, wxID_ANY, _("Duplicate"), wxDefaultPosition, wxDLG_UNIT(this, wxSize(90, 24)), 0);
#if wxVERSION_NUMBER >= 2904
    ...
    m_btToolMagazineAdd =
        new wxButton(this, wxID_ANY, _("New"), wxDefaultPosition, wxDLG_UNIT(this, wxSize(90, 24)), 0);
#if wxVERSION_NUMBER >= 2904
    ...
    m_btToolMagazineEdit =
        new wxButton(this, wxID_ANY, _("Update"), wxDefaultPosition, wxDLG_UNIT(this, wxSize(90, 24)), 0);
#if wxVERSION_NUMBER >= 2904
    ...
    m_btToolMagazineCancle =
        new wxButton(this, wxID_ANY, _("Cancle"), wxDefaultPosition, wxDLG_UNIT(this, wxSize(90, 24)), 0);
#if wxVERSION_NUMBER >= 2904
    ...
    // Connect events
    m_toolMagazine->Bind(wxEVT_COMMAND_LIST_ITEM_SELECTED, &CncToolMagazineBase::selectedTool, this);
    m_cbDefaultToolUsage->Bind(wxEVT_COMMAND_CHECKBOX_CLICKED, &CncToolMagazineBase::clickUseDefaultTool, this);
    m_cbDefaultMappedTo->Bind(wxEVT_COMMAND_COMBOBOX_SELECTED, &CncToolMagazineBase::selectDefaultToolMappedTo, this);
    m_toolMagazineType->Bind(wxEVT_COMMAND_COMBOBOX_SELECTED, &CncToolMagazineBase::selectType, this);
    m_btToolMagazineRemove->Bind(wxEVT_COMMAND_BUTTON_CLICKED, &CncToolMagazineBase::removeTool, this);
    m_btToolMagazineDuplicate->Bind(wxEVT_COMMAND_BUTTON_CLICKED, &CncToolMagazineBase::duplicateTool, this);
    m_btToolMagazineAdd->Bind(wxEVT_COMMAND_BUTTON_CLICKED, &CncToolMagazineBase::addTool, this);
    m_btToolMagazineEdit->Bind(wxEVT_COMMAND_BUTTON_CLICKED, &CncToolMagazineBase::editTool, this);
    m_btToolMagazineCancle->Bind(wxEVT_COMMAND_BUTTON_CLICKED, &CncToolMagazineBase::cancel, this);
}

CncToolMagazineBase::~CncToolMagazineBase()
{
    m_toolMagazine->Unbind(wxEVT_COMMAND_LIST_ITEM_SELECTED, &CncToolMagazineBase::selectedTool, this);
    m_cbDefaultToolUsage->Unbind(wxEVT_COMMAND_CHECKBOX_CLICKED, &CncToolMagazineBase::clickUseDefaultTool, this);
    m_cbDefaultMappedTo->Unbind(wxEVT_COMMAND_COMBOBOX_SELECTED, &CncToolMagazineBase::selectDefaultToolMappedTo, this);
    m_toolMagazineType->Unbind(wxEVT_COMMAND_COMBOBOX_SELECTED, &CncToolMagazineBase::selectType, this);
    m_btToolMagazineRemove->Unbind(wxEVT_COMMAND_BUTTON_CLICKED, &CncToolMagazineBase::removeTool, this);
    m_btToolMagazineDuplicate->Unbind(wxEVT_COMMAND_BUTTON_CLICKED, &CncToolMagazineBase::duplicateTool, this);
    m_btToolMagazineAdd->Unbind(wxEVT_COMMAND_BUTTON_CLICKED, &CncToolMagazineBase::addTool, this);
    m_btToolMagazineEdit->Unbind(wxEVT_COMMAND_BUTTON_CLICKED, &CncToolMagazineBase::editTool, this);
    m_btToolMagazineCancle->Unbind(wxEVT_COMMAND_BUTTON_CLICKED, &CncToolMagazineBase::cancel, this);
}
