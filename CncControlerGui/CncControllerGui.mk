...
CXXFLAGS := -Wno-deprecated-declarations -g1 -fpic -O3 -std=c++2a -Wall -pipe $(shell wx-config --cflags) $(Preprocessors)
...
Objects5=$(IntermediateDirectory)/CircularBuffer.cpp$(ObjectSuffix) $(IntermediateDirectory)/BinaryFileParser.cpp$(ObjectSuffix) $(IntermediateDirectory)/CncGamePadMsw.cpp$(ObjectSuffix) $(IntermediateDirectory)/ManuallyPathHandlerCnc.cpp$(ObjectSuffix) $(IntermediateDirectory)/GCodeFileParser.cpp$(ObjectSuffix) \
	...
	$(IntermediateDirectory)/CncMillingSoundController.cpp$(ObjectSuffix) $(IntermediateDirectory)/CncExternalViewBox.cpp$(ObjectSuffix) $(IntermediateDirectory)/OSD_CncTimeFunctions.cpp$(ObjectSuffix) 
...
$(IntermediateDirectory)/CncAnchorInfo.cpp$(ObjectSuffix): CncAnchorInfo.cpp
	@$(CXX) $(CXXFLAGS) $(IncludePCH) $(IncludePath) -MG -MP -MT$(IntermediateDirectory)/CncAnchorInfo.cpp$(ObjectSuffix) -MF$(IntermediateDirectory)/CncAnchorInfo.cpp$(DependSuffix) -MM CncAnchorInfo.cpp
	$(CXX) $(IncludePCH) $(SourceSwitch) "C:/@Development/@Projekte/c++/CNCGuiController/CncControlerGui/CncAnchorInfo.cpp" $(CXXFLAGS) $(ObjectSwitch)$(IntermediateDirectory)/CncAnchorInfo.cpp$(ObjectSuffix) $(IncludePath)
$(IntermediateDirectory)/CncAnchorInfo.cpp$(PreprocessSuffix): CncAnchorInfo.cpp
	$(CXX) $(CXXFLAGS) $(IncludePCH) $(IncludePath) $(PreprocessOnlySwitch) $(OutputSwitch) $(IntermediateDirectory)/CncAnchorInfo.cpp$(PreprocessSuffix) CncAnchorInfo.cpp
...
$(IntermediateDirectory)/CncTestRunConfig.cpp$(ObjectSuffix): CncTestRunConfig.cpp
	@$(CXX) $(CXXFLAGS) $(IncludePCH) $(IncludePath) -MG -MP -MT$(IntermediateDirectory)/CncTestRunConfig.cpp$(ObjectSuffix) -MF$(IntermediateDirectory)/CncTestRunConfig.cpp$(DependSuffix) -MM CncTestRunConfig.cpp
	$(CXX) $(IncludePCH) $(SourceSwitch) "C:/@Development/@Projekte/c++/CNCGuiController/CncControlerGui/CncTestRunConfig.cpp" $(CXXFLAGS) $(ObjectSwitch)$(IntermediateDirectory)/CncTestRunConfig.cpp$(ObjectSuffix) $(IncludePath)
$(IntermediateDirectory)/CncTestRunConfig.cpp$(PreprocessSuffix): CncTestRunConfig.cpp
	$(CXX) $(CXXFLAGS) $(IncludePCH) $(IncludePath) $(PreprocessOnlySwitch) $(OutputSwitch) $(IntermediateDirectory)/CncTestRunConfig.cpp$(PreprocessSuffix) CncTestRunConfig.cpp
...
$(IntermediateDirectory)/CncSimuHwDimensionSetup.cpp$(ObjectSuffix): CncSimuHwDimensionSetup.cpp
	@$(CXX) $(CXXFLAGS) $(IncludePCH) $(IncludePath) -MG -MP -MT$(IntermediateDirectory)/CncSimuHwDimensionSetup.cpp$(ObjectSuffix) -MF$(IntermediateDirectory)/CncSimuHwDimensionSetup.cpp$(DependSuffix) -MM CncSimuHwDimensionSetup.cpp
	$(CXX) $(IncludePCH) $(SourceSwitch) "C:/@Development/@Projekte/c++/CNCGuiController/CncControlerGui/CncSimuHwDimensionSetup.cpp" $(CXXFLAGS) $(ObjectSwitch)$(IntermediateDirectory)/CncSimuHwDimensionSetup.cpp$(ObjectSuffix) $(IncludePath)
$(IntermediateDirectory)/CncSimuHwDimensionSetup.cpp$(PreprocessSuffix): CncSimuHwDimensionSetup.cpp
	$(CXX) $(CXXFLAGS) $(IncludePCH) $(IncludePath) $(PreprocessOnlySwitch) $(OutputSwitch) $(IntermediateDirectory)/CncSimuHwDimensionSetup.cpp$(PreprocessSuffix) CncSimuHwDimensionSetup.cpp
...
$(IntermediateDirectory)/CncSimpleCalculator.cpp$(ObjectSuffix): CncSimpleCalculator.cpp
	@$(CXX) $(CXXFLAGS) $(IncludePCH) $(IncludePath) -MG -MP -MT$(IntermediateDirectory)/CncSimpleCalculator.cpp$(ObjectSuffix) -MF$(IntermediateDirectory)/CncSimpleCalculator.cpp$(DependSuffix) -MM CncSimpleCalculator.cpp
	$(CXX) $(IncludePCH) $(SourceSwitch) "C:/@Development/@Projekte/c++/CNCGuiController/CncControlerGui/CncSimpleCalculator.cpp" $(CXXFLAGS) $(ObjectSwitch)$(IntermediateDirectory)/CncSimpleCalculator.cpp$(ObjectSuffix) $(IncludePath)
$(IntermediateDirectory)/CncSimpleCalculator.cpp$(PreprocessSuffix): CncSimpleCalculator.cpp
	$(CXX) $(CXXFLAGS) $(IncludePCH) $(IncludePath) $(PreprocessOnlySwitch) $(OutputSwitch) $(IntermediateDirectory)/CncSimpleCalculator.cpp$(PreprocessSuffix) CncSimpleCalculator.cpp
