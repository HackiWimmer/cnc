...
///////////////////////////////////////////////////////////////////
	switch ( pid ) {
		case PID_X_POS: 			Serial_writeLongValue(pid, curSimulatorPos.getX());
									break;
									
		case PID_Y_POS: 			Serial_writeLongValue(pid, curSimulatorPos.getY());
									break;
									
		case PID_Z_POS: 			Serial_writeLongValue(pid, curSimulatorPos.getZ());
									break;
...
///////////////////////////////////////////////////////////////////
	...
	Serial_writeLongValues(PID_LIMIT, curLimitStates.getX(), curLimitStates.getY(), curLimitStates.getZ());
}
///////////////////////////////////////////////////////////////////
...
///////////////////////////////////////////////////////////////////
	...
	switch ( pid ) {
		...
		case PID_X_POS:   					Serial_writeLongValue(pid,  curSimulatorPos.getX()); break;
		case PID_Y_POS:   					Serial_writeLongValue(pid,  curSimulatorPos.getY()); break;
		case PID_Z_POS:  					Serial_writeLongValue(pid,  curSimulatorPos.getZ()); break;
		case PID_XY_POS:  					Serial_writeLongValues(pid, curSimulatorPos.getX(), curSimulatorPos.getY()); break;
		case PID_XYZ_POS: 					Serial_writeLongValues(pid, curSimulatorPos.getX(), curSimulatorPos.getY(), curSimulatorPos.getZ()); break;
		
		case PID_LIMIT:						performLimitStates(); break;
		
		case PID_GET_POS_COUNTER:			Serial_writeLongValues(pid, getPositionCounter(), getPositionOverflowCounter()); break;
		
		case PID_GET_STEP_COUNTER_X:		Serial_writeLongValues(pid, getStepCounterX(), getStepOverflowCounterX()); break;
		case PID_GET_STEP_COUNTER_Y:		Serial_writeLongValues(pid, getStepCounterY(), getStepOverflowCounterY()); break;
		case PID_GET_STEP_COUNTER_Z:		Serial_writeLongValues(pid, getStepCounterZ(), getStepOverflowCounterZ()); break;
