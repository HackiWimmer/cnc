...
Preprocessors          :=$(PreprocessorSwitch)USE_WXCRAFTER 
ObjectSwitch           :=-o 
ArchiveOutputSwitch    := 
...
LinkOptions            :=  -pg -mwindows $(shell wx-config --libs)
IncludePath            :=  $(IncludeSwitch). $(IncludeSwitch)C:\@Development\boost\include\boost-1_64 $(IncludeSwitch). $(IncludeSwitch)C:\@Development\wxWidgets-3.1.0\src\stc\scintilla\include $(IncludeSwitch)C:\@Development\wxWidgets-3.1.0\src\stc\scintilla\lexlib 
IncludePCH             := 
RcIncludePath          := 
...
CXXFLAGS := -Wno-deprecated-declarations -pg -g -O0 -std=c++14 -std=c++11 -Wall $(shell wx-config --cflags) $(Preprocessors)
...
Objects1=$(IntermediateDirectory)/InterruptThread.cpp$(ObjectSuffix) $(IntermediateDirectory)/DataControlModel.cpp$(ObjectSuffix) $(IntermediateDirectory)/CncSpyControl.cpp$(ObjectSuffix) \
	...
	$(IntermediateDirectory)/SvgEditPopup.cpp$(ObjectSuffix) $(IntermediateDirectory)/SVGElementConverter.cpp$(ObjectSuffix) $(IntermediateDirectory)/SvgUnitCalculator.cpp$(ObjectSuffix) $(IntermediateDirectory)/PathGeneratorBase.cpp$(ObjectSuffix) $(IntermediateDirectory)/PathGenerators.cpp$(ObjectSuffix) 
...
$(IntermediateDirectory)/up_up_up_up_wxWidgets-3.1.0_src_stc_scintilla_lexers_LexGCode.cxx$(ObjectSuffix): ../../../../wxWidgets-3.1.0/src/stc/scintilla/lexers/LexGCode.cxx $(IntermediateDirectory)/up_up_up_up_wxWidgets-3.1.0_src_stc_scintilla_lexers_LexGCode.cxx$(DependSuffix)
	$(CXX) $(IncludePCH) $(SourceSwitch) "C:/@Development/wxWidgets-3.1.0/src/stc/scintilla/lexers/LexGCode.cxx" $(CXXFLAGS) $(ObjectSwitch)$(IntermediateDirectory)/up_up_up_up_wxWidgets-3.1.0_src_stc_scintilla_lexers_LexGCode.cxx$(ObjectSuffix) $(IncludePath)
$(IntermediateDirectory)/up_up_up_up_wxWidgets-3.1.0_src_stc_scintilla_lexers_LexGCode.cxx$(DependSuffix): ../../../../wxWidgets-3.1.0/src/stc/scintilla/lexers/LexGCode.cxx
	@$(CXX) $(CXXFLAGS) $(IncludePCH) $(IncludePath) -MG -MP -MT$(IntermediateDirectory)/up_up_up_up_wxWidgets-3.1.0_src_stc_scintilla_lexers_LexGCode.cxx$(ObjectSuffix) -MF$(IntermediateDirectory)/up_up_up_up_wxWidgets-3.1.0_src_stc_scintilla_lexers_LexGCode.cxx$(DependSuffix) -MM ../../../../wxWidgets-3.1.0/src/stc/scintilla/lexers/LexGCode.cxx

$(IntermediateDirectory)/up_up_up_up_wxWidgets-3.1.0_src_stc_scintilla_lexers_LexGCode.cxx$(PreprocessSuffix): ../../../../wxWidgets-3.1.0/src/stc/scintilla/lexers/LexGCode.cxx
	$(CXX) $(CXXFLAGS) $(IncludePCH) $(IncludePath) $(PreprocessOnlySwitch) $(OutputSwitch) $(IntermediateDirectory)/up_up_up_up_wxWidgets-3.1.0_src_stc_scintilla_lexers_LexGCode.cxx$(PreprocessSuffix) ../../../../wxWidgets-3.1.0/src/stc/scintilla/lexers/LexGCode.cxx

$(IntermediateDirectory)/up_up_up_up_wxWidgets-3.1.0_src_stc_scintilla_src_Catalogue.cxx$(ObjectSuffix): ../../../../wxWidgets-3.1.0/src/stc/scintilla/src/Catalogue.cxx $(IntermediateDirectory)/up_up_up_up_wxWidgets-3.1.0_src_stc_scintilla_src_Catalogue.cxx$(DependSuffix)
	$(CXX) $(IncludePCH) $(SourceSwitch) "C:/@Development/wxWidgets-3.1.0/src/stc/scintilla/src/Catalogue.cxx" $(CXXFLAGS) $(ObjectSwitch)$(IntermediateDirectory)/up_up_up_up_wxWidgets-3.1.0_src_stc_scintilla_src_Catalogue.cxx$(ObjectSuffix) $(IncludePath)
$(IntermediateDirectory)/up_up_up_up_wxWidgets-3.1.0_src_stc_scintilla_src_Catalogue.cxx$(DependSuffix): ../../../../wxWidgets-3.1.0/src/stc/scintilla/src/Catalogue.cxx
	@$(CXX) $(CXXFLAGS) $(IncludePCH) $(IncludePath) -MG -MP -MT$(IntermediateDirectory)/up_up_up_up_wxWidgets-3.1.0_src_stc_scintilla_src_Catalogue.cxx$(ObjectSuffix) -MF$(IntermediateDirectory)/up_up_up_up_wxWidgets-3.1.0_src_stc_scintilla_src_Catalogue.cxx$(DependSuffix) -MM ../../../../wxWidgets-3.1.0/src/stc/scintilla/src/Catalogue.cxx

$(IntermediateDirectory)/up_up_up_up_wxWidgets-3.1.0_src_stc_scintilla_src_Catalogue.cxx$(PreprocessSuffix): ../../../../wxWidgets-3.1.0/src/stc/scintilla/src/Catalogue.cxx
	$(CXX) $(CXXFLAGS) $(IncludePCH) $(IncludePath) $(PreprocessOnlySwitch) $(OutputSwitch) $(IntermediateDirectory)/up_up_up_up_wxWidgets-3.1.0_src_stc_scintilla_src_Catalogue.cxx$(PreprocessSuffix) ../../../../wxWidgets-3.1.0/src/stc/scintilla/src/Catalogue.cxx
