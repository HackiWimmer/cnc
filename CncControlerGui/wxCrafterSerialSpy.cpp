...
CncSerialSpyPanelBase::CncSerialSpyPanelBase(wxWindow* parent,
    wxWindowID id,
    const wxPoint& pos,
    const wxSize& size,
    long style)
    : wxPanel(parent, id, pos, size, style)
{
    ...
    m_enableSerialSpy =
        new wxBitmapToggleButton(m_panel9492, wxID_ANY, wxXmlResource::Get()->LoadBitmap(wxT("16-connected")),
            wxDefaultPosition, wxDLG_UNIT(m_panel9492, wxSize(26, 26)), 0);
    ...
    m_MarkSerialSpy =
        new wxButton(m_panel9492, wxID_ANY, wxT(""), wxDefaultPosition, wxDLG_UNIT(m_panel9492, wxSize(26, 26)), 0);
    ...
    m_staticLine9487 = new wxStaticLine(
        m_panel9492, wxID_ANY, wxDefaultPosition, wxDLG_UNIT(m_panel9492, wxSize(-1, -1)), wxLI_VERTICAL);
    ...
    m_staticLine94873 = new wxStaticLine(
        m_panel9492, wxID_ANY, wxDefaultPosition, wxDLG_UNIT(m_panel9492, wxSize(-1, -1)), wxLI_VERTICAL);

    flexGridSizer27302->Add(m_staticLine94873, 0, wxALL | wxEXPAND, WXC_FROM_DIP(1));

    wxArrayString m_cbSerialSpyModeArr;
    m_cbSerialSpyModeArr.Add(_("Spy - In"));
    m_cbSerialSpyModeArr.Add(_("Spy - Out"));
    m_cbSerialSpyModeArr.Add(_("Spy - In/Out"));
    m_cbSerialSpyMode = new wxComboBox(m_panel9492, wxID_ANY, wxT(""), wxDefaultPosition,
        wxDLG_UNIT(m_panel9492, wxSize(-1, -1)), m_cbSerialSpyModeArr, wxCB_READONLY);
    wxFont m_cbSerialSpyModeFont(
    ...
    m_staticLine9489 = new wxStaticLine(
        m_panel9492, wxID_ANY, wxDefaultPosition, wxDLG_UNIT(m_panel9492, wxSize(-1, -1)), wxLI_VERTICAL);
    ...
    m_liveDecoding =
        new wxBitmapToggleButton(m_panel9492, wxID_ANY, wxXmlResource::Get()->LoadBitmap(wxT("brick-edit")),
            wxDefaultPosition, wxDLG_UNIT(m_panel9492, wxSize(26, 26)), 0);
    ...
    m_liveDebug = new wxBitmapToggleButton(m_panel9492, wxID_ANY, wxXmlResource::Get()->LoadBitmap(wxT("bug-error")),
        wxDefaultPosition, wxDLG_UNIT(m_panel9492, wxSize(26, 26)), 0);
    ...
    m_autoScroling =
        new wxBitmapToggleButton(m_panel9492, wxID_ANY, wxXmlResource::Get()->LoadBitmap(wxT("auto-scroll")),
            wxDefaultPosition, wxDLG_UNIT(m_panel9492, wxSize(26, 26)), 0);
    ...
    m_autoColumnSizing = new wxBitmapToggleButton(m_panel9492, wxID_ANY,
        wxXmlResource::Get()->LoadBitmap(wxT("format-table-column-width")), wxDefaultPosition,
        wxDLG_UNIT(m_panel9492, wxSize(26, 26)), 0);
    ...
    m_clearSerialSpyOnConnect =
        new wxBitmapToggleButton(m_panel9492, wxID_ANY, wxXmlResource::Get()->LoadBitmap(wxT("brick-delete")),
            wxDefaultPosition, wxDLG_UNIT(m_panel9492, wxSize(26, 26)), 0);
    ...
    m_clearSerialSpyBeforNextRun =
        new wxBitmapToggleButton(m_panel9492, wxID_ANY, wxXmlResource::Get()->LoadBitmap(wxT("script-delete")),
            wxDefaultPosition, wxDLG_UNIT(m_panel9492, wxSize(26, 26)), 0);
    ...
    m_staticLine9495 = new wxStaticLine(
        m_panel9492, wxID_ANY, wxDefaultPosition, wxDLG_UNIT(m_panel9492, wxSize(-1, -1)), wxLI_VERTICAL);

    flexGridSizer4706->Add(m_staticLine9495, 0, wxALL | wxEXPAND, WXC_FROM_DIP(1));

    m_openDetails = new wxBitmapButton(m_panel9492, wxID_ANY, wxXmlResource::Get()->LoadBitmap(wxT("document-open-6")),
        wxDefaultPosition, wxDLG_UNIT(m_panel9492, wxSize(26, 26)), wxBU_AUTODRAW);
    ...
    m_staticText9524 =
        new wxStaticText(this, wxID_ANY, _("Update Interval:"), wxDefaultPosition, wxDLG_UNIT(this, wxSize(-1, -1)), 0);
    ...
    m_sliderUpdateInterval = new wxSlider(
        this, wxID_ANY, 800, 100, 1000, wxDefaultPosition, wxDLG_UNIT(this, wxSize(-1, -1)), wxSL_HORIZONTAL);
    ...
    m_staticText9539 =
        new wxStaticText(this, wxID_ANY, _("[ms]"), wxDefaultPosition, wxDLG_UNIT(this, wxSize(-1, -1)), 0);
    ...
    // Connect events
    m_enableSerialSpy->Bind(wxEVT_COMMAND_TOGGLEBUTTON_CLICKED, &CncSerialSpyPanelBase::enableSerialSpy, this);
    m_MarkSerialSpy->Bind(wxEVT_COMMAND_BUTTON_CLICKED, &CncSerialSpyPanelBase::markSerialSpy, this);
    m_clearSerialSpy->Bind(wxEVT_COMMAND_BUTTON_CLICKED, &CncSerialSpyPanelBase::clearSerialSpy, this);
    m_cbSerialSpyMode->Bind(wxEVT_COMMAND_COMBOBOX_SELECTED, &CncSerialSpyPanelBase::selectSerialSpyMode, this);
    m_liveDecoding->Bind(wxEVT_COMMAND_TOGGLEBUTTON_CLICKED, &CncSerialSpyPanelBase::onLiveDecoding, this);
    m_liveDebug->Bind(wxEVT_COMMAND_TOGGLEBUTTON_CLICKED, &CncSerialSpyPanelBase::onLiveDebug, this);
    m_autoScroling->Bind(wxEVT_COMMAND_TOGGLEBUTTON_CLICKED, &CncSerialSpyPanelBase::onAutoScrolling, this);
    m_autoColumnSizing->Bind(wxEVT_COMMAND_TOGGLEBUTTON_CLICKED, &CncSerialSpyPanelBase::onAutoColumnSize, this);
    m_openDetails->Bind(wxEVT_COMMAND_BUTTON_CLICKED, &CncSerialSpyPanelBase::openSpyDetailWindow, this);
    m_sliderUpdateInterval->Bind(wxEVT_SCROLL_THUMBTRACK, &CncSerialSpyPanelBase::onUpdateIntervalSlider, this);
    m_sliderUpdateInterval->Bind(wxEVT_SCROLL_THUMBRELEASE, &CncSerialSpyPanelBase::onUpdateIntervalSlider, this);
    m_sliderUpdateInterval->Bind(wxEVT_SCROLL_CHANGED, &CncSerialSpyPanelBase::onUpdateIntervalSlider, this);
}

CncSerialSpyPanelBase::~CncSerialSpyPanelBase()
{
    m_enableSerialSpy->Unbind(wxEVT_COMMAND_TOGGLEBUTTON_CLICKED, &CncSerialSpyPanelBase::enableSerialSpy, this);
    m_MarkSerialSpy->Unbind(wxEVT_COMMAND_BUTTON_CLICKED, &CncSerialSpyPanelBase::markSerialSpy, this);
    m_clearSerialSpy->Unbind(wxEVT_COMMAND_BUTTON_CLICKED, &CncSerialSpyPanelBase::clearSerialSpy, this);
    m_cbSerialSpyMode->Unbind(wxEVT_COMMAND_COMBOBOX_SELECTED, &CncSerialSpyPanelBase::selectSerialSpyMode, this);
    m_liveDecoding->Unbind(wxEVT_COMMAND_TOGGLEBUTTON_CLICKED, &CncSerialSpyPanelBase::onLiveDecoding, this);
    m_liveDebug->Unbind(wxEVT_COMMAND_TOGGLEBUTTON_CLICKED, &CncSerialSpyPanelBase::onLiveDebug, this);
    m_autoScroling->Unbind(wxEVT_COMMAND_TOGGLEBUTTON_CLICKED, &CncSerialSpyPanelBase::onAutoScrolling, this);
    m_autoColumnSizing->Unbind(wxEVT_COMMAND_TOGGLEBUTTON_CLICKED, &CncSerialSpyPanelBase::onAutoColumnSize, this);
    m_openDetails->Unbind(wxEVT_COMMAND_BUTTON_CLICKED, &CncSerialSpyPanelBase::openSpyDetailWindow, this);
    m_sliderUpdateInterval->Unbind(wxEVT_SCROLL_THUMBTRACK, &CncSerialSpyPanelBase::onUpdateIntervalSlider, this);
    m_sliderUpdateInterval->Unbind(wxEVT_SCROLL_THUMBRELEASE, &CncSerialSpyPanelBase::onUpdateIntervalSlider, this);
    m_sliderUpdateInterval->Unbind(wxEVT_SCROLL_CHANGED, &CncSerialSpyPanelBase::onUpdateIntervalSlider, this);
}
