    ...
    : wxFrame(parent, id, title, pos, size, style)
{
    ...
    m_auibarMain->AddTool(wxID_ANY, _("Tool Label"), wxXmlResource::Get()->LoadBitmap(wxT("sports-shuttlecock")), wxNullBitmap, wxITEM_NORMAL, _("Config Step Delay"), wxT(""), NULL);
