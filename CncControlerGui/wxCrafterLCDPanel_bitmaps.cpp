...
void wxCDC1CInitBitmapResources()
{
    ...
    XRC_ADD_FILE(wxT("XRC_resource/wxCrafterLCDPanel_bitmaps.cpp$C__@Development_@Projekte_c++_CNCGuiController_CncControlerGui_wxCrafterLCDPanel_bitmaps.xrc"), xml_res_file_0, xml_res_size_0, wxT("text/xml"));
    wxXmlResource::Get()->Load(wxT("memory:XRC_resource/wxCrafterLCDPanel_bitmaps.cpp$C__@Development_@Projekte_c++_CNCGuiController_CncControlerGui_wxCrafterLCDPanel_bitmaps.xrc"));
}
