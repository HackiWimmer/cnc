...
, factorX( THE_CONFIG->getCalculationFactX() / THE_CONFIG->getDispFactX3D() )
, factorY( THE_CONFIG->getCalculationFactY() / THE_CONFIG->getDispFactY3D() )
, factorZ( THE_CONFIG->getCalculationFactZ() / THE_CONFIG->getDispFactZ3D() )
, minX(0.0)
, maxX(0.0)
, minY(0.0)
, maxY(0.0)
